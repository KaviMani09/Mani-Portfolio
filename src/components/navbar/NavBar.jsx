      ...
      <nav className=" container m-auto flex items-center justify-between">
        ...
        >
          ...
          >
           ...
           className= "bg-black text-white px-8 py-2 rounded-lg font-bold hover:text-yellow-400 md:m-5 md:block md:mx-auto md:w-fit lg:px-3"
          aria-label="Call me at +91 78239 99388" 
         >
          HIRE ME
       </a>
          </ul>
